    ...
    <div className="max-w-3xl mx-auto space-y-6 p-4">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Global AI, traffic, pricing, and infrastructure rules
        </p>
          ...
          <Card className="p-6 space-y-5">
            ...
            <div>
              ...
              <Input
                ...
                value={
                  settings.maxQueueCapacityGlobal
                }


                onChange={(e)=>
                  update(
                    "maxQueueCapacityGlobal",
                    Number(e.target.value)
                  )
                }
            ...
            <div>
              ...
              <Input
                ...
                value={
                  settings.maxRequestDistanceKm
                }


                onChange={(e)=>
                  update(
                    "maxRequestDistanceKm",
                    Number(e.target.value)
                  )
                }
            ...
            <div>
              ...
              <Label>
                Max Active Cameras Per Station
              </Label>
              ...
              <Input
                ...
                value={
                  settings.maxActiveCamerasPerStation
                }
